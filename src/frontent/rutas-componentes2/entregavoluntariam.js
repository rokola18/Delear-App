...
const EntregaVoluntariaM = ({texts}) => {
            ...
            <section>
                    ...
                    <p>
                        En el Municipio de Consuelo, Provincia de San Pedro de Macorís, República Dominicana, a los (________________), días del Mes de _______________, del Año Dos Mil
                         __________________, 20___, quienes suscriben los Señores(as) <span>{texts.vendedor}</span> dominicana, mayor de edad, soltera, portadora de la cedula de identidad y electoral 
                    ...
                    <p>
                       ...
                       en mi presencia Libre y  voluntariamente por los Señores(as), <span>{texts.vendedor}</span> (PARTE QUE ENTREGA) y <span>FINAUTO FPG LA MAYOR 
...
export default EntregaVoluntariaM