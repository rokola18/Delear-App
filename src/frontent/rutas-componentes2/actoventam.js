        ...
        <div>
            ...
            <section className='primera bajar'>        
               ...
               <p className='venta'>
                 ...
                 electoral No.<span>{texts.cedula}</span>, con domicilio y residencia en el sector <span className='nada'>{texts.sector}</span>, calle <span>{texts.calle}</span> casa <span>{texts.casa}</span> <span>{texts.municipioprovincia}</span>, quien en lo que sigue del presente acto se denominará <span>LA COMPRADORA</span>; 
               </p>
               <p className='venta'>
               ...
               <p className='venta'>
               <span>PRIMERO: EL VENDEDOR</span>, por medio del presente acto, VENDE, CEDE Y TRANSFIERE, con todas las garantías de derecho a la COMPRADORA, quien acepta conforme el 
               siguiente vehículo que se describe a continuación:
               </p>

               <div className='actomoto'>
                  <div>MARCA: {texts.marca}</div>
              ...
              <p className='venta'>
                ...
                <span> EL VENDEDOR</span>, asegura haber recibido de manos de la COMPRADORA, por lo que por medio de este mismo acto le entrega recibo formal de descargo y finiquito. . 
              </p>

              <p className='venta'>
                <span>TERCERO: LA COMPRADORA,</span> justifica su derecho de propiedad mediante la posesión del vehículo, matrícula original, para todos los casos no 
...
______________________________________
                ...
                <p className='venta'>
                  ...
                  <span> {texts.vendedor}</span>, (LA COMPRADORA) Y LA <span>COMPAÑIA FINAUTO FPG LA MAYOR DEL ESTE, SRL</span>; RNC-132-08635-1, REPRESENTADA POR EL SEÑOR <span>LEONARDO SANCHEZ MERCEDES </span> 
...
export default ActoMotocicletasm