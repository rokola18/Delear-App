        ...
        <div>
            <div className='despacho'>
                ...
                <p className='info'>
                  ...
                  AÑO: <span>{texts.año}</span>, COLOR: <span>{texts.color}</span>, a la Señora <span>{texts.vendedor}</span> portadora de la cedula de identidad y electoral 
                ...
                <span> CORRESPONDEN</span> a los SRES(AS), e <span>FINAUTO LA MAYOR DEL ESTE</span>, cuyas generales constan, por las mismas 
