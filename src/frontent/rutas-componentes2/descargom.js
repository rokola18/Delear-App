...
const Descargo = ({texts}) => {
    return(
        <div>
            <div className="recargo">
                <h3 className='descargo'>DESCARGO DE RESPONSABILIDAD CIVIL Y/O PENAL</h3>
                <p className='prime'>
                  YO, <span>{texts.vendedor}</span>, dominicana, mayor de edad, Titular de la Cedula de Identidad y 
                ...
                <p className='prime'>
                <span>PRIMERO:</span> Que en fecha {texts.dia} días del mes de {texts.mes} del año {texts.añonumero}, he adquirido conforme y a mi entera 
                ...
                <p className='prime'><span>Marca:</span> {texts.marca}</p>
                <p className='prime'><span>Modelo:</span> {texts.modelo}</p>
                ...
                <p className='prime'>
                <span>SEGUNDO:</span> Que hasta tanto se haga el traspaso de la matricula a mi nombre, asumo TOTAL responsabilidad de 
                ...
                eximo y me obligo a mantener indemne a la sociedad comercial <span>FINAUTO LA MAYOR DEL ESTE</span> de cualquier reclamo, acción 
                ...
                <p className='prime'>
                YO, <span>Dr. Ramón Augusto Gómez Mejia</span>, Abogado-Notario Público de los del Número del Distrito Nacional, miembro activo del 
