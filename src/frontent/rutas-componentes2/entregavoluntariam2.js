            ...
            <section>
                    ...
                    <p>
                        En el Municipio de Consuelo, Provincia de San Pedro de Macorís, República Dominicana, a los (________________), días del Mes de _______________, del Año Dos Mil
                         __________________, 20___, quienes suscriben los Señores(as) <span>{texts.garante}</span> dominicano(a), mayor de edad, soltero(a), portador(a) de la cedula de identidad y electoral 
                         No.<span>{texts.garantecedula}</span>, con domicilio y residencia en el sector <span>{texts.sectorgarante}</span>, calle <span>{texts.callegarante}</span> casa <span>{texts.casagarante}</span>, {texts.municipioprovinciagarante}, por medio del presente documento formalizamos 
