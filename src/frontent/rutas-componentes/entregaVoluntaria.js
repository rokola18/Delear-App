...
import '../css/entregaVoluntaria.css'


const EntregaVoluntaria = ({texts}) => {
                ...
                <section>
                    ...
                    <p>
                        En el Municipio de Consuelo, Provincia de San Pedro de Macorís, República Dominicana, a los (________________), días del Mes de _______________, del Año Dos Mil
                         __________________, 20___, quienes suscriben los señores <span>{texts.vendedor}</span> dominicano, mayor de edad, soltero, portador de la cedula de identidad y electoral 
                    ...
                    <p>
                       ...
                       en mi presencia Libre y  voluntariamente por los señores, <span>{texts.vendedor}</span> (PARTE QUE ENTREGA) y <span>FINAUTO FPG LA MAYOR 
...
export default EntregaVoluntaria