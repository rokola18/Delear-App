    ...
    return(
        <div>
            ...
            <section className='primera bajar'>        
               ...
               <h3 className='titulo-2'> ACTO DE VENTA BAJO FIRMA PRIVADA.</h3>
               <p>
         ...
         <section className='segunda'>
               ...
               <p>
                 Hecho en un (02) original, en la Ciudad, Municipio y Provincia de San Pedro de Macorís, República Dominicana. A los ({texts.dia}) días del mes de {texts.mes} del año
                 {texts.añoletra} ({texts.añonumero}).
               </p>
